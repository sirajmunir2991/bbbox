...
export default function TableList(props) {
    ...
    useEffect(() => {
        ...
        let customerId = new URLSearchParams(props.location.search).get("customerId");
        let supplierID = new URLSearchParams(props.location.search).get("supp");
        let radioGroup = new URLSearchParams(props.location.search).get("radioGroup");

        tableService.SalesByCustomer(from, to,supplierID,customerId,radioGroup).then((res) => {
