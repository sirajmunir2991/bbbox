...
export default function TableList(props) {
  ...
  useEffect(() => {
    ...
    let fromBranchId = new URLSearchParams(props.location.search).get("fromBranchId");
    let toBranchId = new URLSearchParams(props.location.search).get("toBranchId");
    tableService.StockTransfer(from, to,fromBranchId,toBranchId).then((res) => {
