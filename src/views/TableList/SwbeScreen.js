...
export default function TableList(props) {
    ...
    useEffect(() => {
        ...
        let order = new URLSearchParams(props.location.search).get("order");
        let dir = new URLSearchParams(props.location.search).get("dir");
        let selectedFrom = new URLSearchParams(props.location.search).get("selectedFrom");
        let selectedTo = new URLSearchParams(props.location.search).get("selectedTo");
        ...
        tableService.SWBE(selectedDate, location, category, brand, supplier, origin, min, max, selectedFrom, selectedTo, group, dir, order).then((res) => {
