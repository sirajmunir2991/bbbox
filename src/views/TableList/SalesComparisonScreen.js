...
export default function TableList(props) {
    ...
    useEffect(() => {
        ...
        let secondfrom = new URLSearchParams(props.location.search).get("secondfrom");
        let secondto = new URLSearchParams(props.location.search).get("secondto");
       

        tableService.SalesComparison(from, to,secondfrom,secondto).then((res) => {
