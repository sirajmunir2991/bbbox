      ...
      <table style={{ width: "100%", border: "1px solid black" , borderCollapse:"collapse"}}>
        <thead style={{ display:"table-header-group" }}>
          <tr style={{ border: "1px solid black" }}>
            ...
            <th>Qty</th>
            <th>Sale Rate</th>
            <th>Sale inv total</th>
            <th>Khyber Rate</th>
            <th>Khyber inv Total</th>
          </tr>
        </thead>
        <tr style={{ border: "1px solid black" }}>
          <td colspan="4" style={{ border: "1px solid black", fontWeight:"normal" }}>Total Sale</td>
          <td style={{border: "1px solid black",fontWeight:"bold"}}>0</td>
...
Cust Name</td>
          <td colSpan={"2"} style={{fontWeight:"bold"}}>Inv No.</td>
          <td colSpan={"2"} style={{fontWeight:"bold"}}>Inv Amount</td>
          <td colSpan={"2"} style={{fontWeight:"bold"}}>Tatara</td>
        </tr>
        
        <tr style={{ border: "1px solid black" }}>
          <td colspan="4" style={{ border: "1px solid black", fontWeight:"normal" }}>Total Sale</td>
          <td colspan="2" style={{border: "1px solid black",fontWeight:"bold"}}>0</td>
          <td colSpan="1" style={{fontWeight:"bold"}}>0</td>
        </tr>
